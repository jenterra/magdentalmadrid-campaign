...
export function GalleryGrid() {
  ...
  const shareImage = async () => {
    ...
    try {
      if (navigator.share) {
        await navigator.share({ title: current.alt, url });
      } else {
      ...
      {isOpen && current && activeIndex !== null && (
        ...
        >
          ...
          <div className="gallery-lightbox__toolbar">
            <button
              type="button"
              className="gallery-lightbox__tool"
            ...
            <button
              type="button"
              className="gallery-lightbox__tool gallery-lightbox__tool--close"
              onClick={close}
              aria-label="Cerrar"
            >
              <CloseIcon />
